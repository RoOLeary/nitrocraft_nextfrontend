        ...
        <li className="o-grid__col xs:o-grid__col--span-6 m:o-grid__col--span-3 l:o-grid__col--span-2">
            <article className="b-speaker" itemType="http://schema.org/Person" itemProp="performer" itemScope="">
                ...
                <div className="b-speaker__photo">
                    <img alt="Project" className="b-speaker__photoImg" itemProp="image" loading="lazy" src={projectImage ? projectImage : "https://placedog.net/184/230"} />
                </div>
                <div className="b-speaker__details">
                    <h3 className="b-speaker__name" itemProp="name">{projectName}</h3>
                    <div className="b-speaker__role" itemProp="jobTitle">{projectDescription}</div>
